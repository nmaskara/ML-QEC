...
aws s3 cp models/square_5_10000000_200_300_1000_10.hdf5 \
	s3://nmaskara-models/square_5_10000000_200_300_1000_10.hdf5
aws s3 cp log1.txt s3://nmaskara-models/results/log1.txt
sudo shutdown -h now
